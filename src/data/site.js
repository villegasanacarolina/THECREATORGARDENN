export const CONTACT_EMAIL = 'thecreatorgardenn@gmail.com'
...
export const approachBlocks = [
  {
    kicker: 'Our approach',
    text: 'We blend strategy, branding, design, and technology to create digital experiences that resonate and build meaningful connections.',
  },
  {
...
export const serviceIntro = {
  left: 'The Creator Garden delivers unparalleled service, blending strategic foresight with unmatched creative brilliance and innovation.',
  right: 'As a leading design studio, we create exceptional experiences for prestigious global clients, crafting a legacy of excellence and impact.',
}
