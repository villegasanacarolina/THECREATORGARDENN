...
const Approach = () => {
  return (
    <div className='relative min-h-screen overflow-hidden bg-black pb-0 text-black lg:text-black'>
      <SectionImage mobileSrc='/images/DALI-Mobile.jpg' desktopSrc='/images/DALI-Desktop.jpg' alt='' />
