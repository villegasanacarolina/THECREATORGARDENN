      ...
      <div className='relative z-10 flex min-h-dvh items-center justify-center px-6'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <ScrollSmokeReveal
            ...
            className='font-[font1] text-[1.4rem] leading-snug [text-shadow:0_4px_14px_rgba(0,0,0,0.68)] lg:text-[1.7rem]'
            immediate
            delay={0.08}
          />
          ...
          <a
            ...
            className='block font-[font1] text-[1.4rem] leading-snug [text-shadow:0_4px_14px_rgba(0,0,0,0.68)] transition-colors hover:text-[#D9A99B] lg:text-[1.7rem]'
          >
